...
|---------|--------------|-------|-------------|
| v0.1.0  | 2025-01-06   | Initial Release | Core protocol, async-first design, skills system, pipe operator (`|`) |
| v0.1.1  | 2025-01-06   | Documentation & Examples | Cookbook section, testing patterns, roadmap documentation |
| v0.1.2  | 2025-01-06   | Type Improvements | Type utilities, Result type, better error messages |
| v0.1.3  | 2025-01-06   | Core API Refinement | Renamed NanobrickSimple to Nanobrick, enhanced git integration |
| v0.2.0  | 2025-06-05   | Composition Revolution | Pipeline Builder API, `>>` operator migration, test suite cleanup |
| v0.2.1  | 2025-06-05   | Developer Experience | Task namespace refactoring, improved symlink handling |
| v0.2.2  | 2025-06-05   | Task System & Docs | Taskfile organization, pipe operator migration completion |
| v0.2.3  | 2025-06-06   | AI-First Documentation | Agentic docs system, AI workflows, documentation restructuring |
...
## Version 0.2.2: Task System Organization ✅

**Status**: Released 2025-06-05

**Theme**: Better task organization and documentation consistency
...
1. **Task System Restructuring**
   ...
   - Extracted common Claude CLI discovery logic
   - Applied DRY principles across taskfiles

2. **Documentation Consistency**
   - Completed migration from `|` to `>>` operator
   - Fixed method references and cookbook examples
...
3. **Enhanced Claude Integration**
   ...
   - Better error messages and setup documentation

## Version 0.2.3: AI-First Documentation ✅

**Status**: Released 2025-06-06

**Theme**: Revolutionary agentic documentation for AI developers

### What Was Delivered

1. **AI-First Documentation System**
   - Created docs/agentic/ directory with specialized formats
   - Implemented llms.txt standard for AI discovery
   - Added executable contracts and JSON-LD knowledge graphs
   - Built comprehensive task registry and tool definitions

2. **Agentic Task Workflows**
   - Added Taskfile.agentic.yml with validation and sync tasks
   - Automated context generation from code
   - Version management for agentic documentation
   - CI/CD integration for validation

3. **Documentation Bridge System**
   - Context injection for Quarto documents
   - AI-specific CSS classes for visual differentiation
   - Dual-mode documentation supporting both audiences

4. **Documentation Restructuring**
   - Reordered sections for better flow
   - Consolidated Evolution section with nested subsections
   - Fixed markdown formatting across 36 files
